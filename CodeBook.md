...
## Transformation details of run_analysis.R
...
* Requires both the ```reshapre2``` and ```data.table``` libraries.
...
* Processes the data. There are two parts: test and train data are processed independently.
* Merge the data sets.
* Write out the tidy_data file
